...
namespace Sibers.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Name,LastName,Patronymic,Email")] Employees employees)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Name,LastName,Patronymic,Email")] Employees employees)
        {
            if (ModelState.IsValid)
            {
